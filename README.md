...
4.  **`plot.ipynb`**: This notebook is for generating plots and visualizations of the results.
5.  **`Photometry_rust.ipynb`** in Photometry_rust folder: This notebooks are for performing photometric analysis on the processed data.
